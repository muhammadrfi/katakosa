...
const MasteredWordsPracticePage = () => {
  ...
  const masteredWords = useMemo(() => {
    // Filter for words that have been marked as mastered
    ...
    <div className="container mx-auto py-12 px-6 max-w-4xl">
      ...
      <Card>
        <CardHeader className="items-center text-center">
          ...
          <CardTitle>Kata-kata Ingat: {project.name}</CardTitle>
          <CardDescription>
            Daftar kata-kata yang telah Anda kuasai.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {masteredWords.length > 0 ? (
            ...
            <div className="text-center">
              <p className="text-lg font-semibold mb-4">Tidak ada kata yang ditandai ingat dalam proyek ini.</p>
...
export default MasteredWordsPracticePage;
